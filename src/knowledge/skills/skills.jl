...
const END_OF_FILE_TAG = "ENDOFFILE"
...
export ShellCommand, SendKeyCommand, CatFileCommand, ClickCommand, CreateFileCommand, ModifyFileCommand, EmailCommand
