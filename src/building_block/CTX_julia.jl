...
function init_julia_context(;verbose=true)
  ...
  jl_pkg_index = get_index(cached_jl_simi_filter, CachedLoader(loader=JuliaLoader(),memory=Dict{String,OrderedDict{String,String}}())(SourceChunker()))
