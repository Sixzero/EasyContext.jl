...
@testset "Large file modification test" begin
    ...
    @testset "Small file append" begin
        ...
        @test occursin("function dummy_function_300(x::Int)", modified_cb.postcontent)  # Check last function preserved
    ...
    @testset "Insert after specific function" begin
        ...
        @test occursin("function dummy_function_300(x::Int)", modified_cb.postcontent)
    end
